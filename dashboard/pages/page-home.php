...
?>
<?php do_action( "amd_home_before_icon_cards" ); ?>
<div class="row">
...
<div class="h-10"></div>
<?php do_action( "amd_home_after_icon_cards" ); ?>
<?php do_action( "amd_home_before_cards" ); ?>
<div class="card-columns template-1">
    <?php foreach( $cards as $card ) amd_dump_single_card( $card ); ?>
</div>
<div class="h-100"></div>
<?php do_action( "amd_home_after_cards" ); ?>