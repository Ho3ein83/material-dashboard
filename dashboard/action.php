...
$data = apply_filters( "amd_action_$action", $scope );
...
amd_add_element_class( "body", [$theme, $direction, $current_locale, "icon-$icon_pack", "theme-$theme"] );
...
<head>
	...
	<?php do_action( "amd_action_header" ); ?>
	<?php amd_load_part( "header" ); ?>
    <title><?php echo esc_html( apply_filters( "amd_action_page_title", $blog_name ) ); ?></title>
</head>
...
<?php do_action( "amd_after_action_page" ); ?>
</body>
</html>