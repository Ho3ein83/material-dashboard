...
@font-face {
    ...
    font-weight: normal;
    font-display: swap;
    src: url("<?php echo $baseURL; ?>/kalameh_old/normal/kalameh_normal.woff2") format("woff2"),
    url("<?php echo $baseURL; ?>/kalameh_old/normal/kalameh_normal.woff") format("woff"),
    url("<?php echo $baseURL; ?>/kalameh_old/normal/kalameh_normal.ttf") format("truetype");
}
...
@font-face {
    ...
    font-weight: bold;
    font-display: swap;
    src: url("<?php echo $baseURL; ?>/kalameh_old/bold/kalameh_bold.woff2") format("woff2"),
    url("<?php echo $baseURL; ?>/kalameh_old/bold/kalameh_bold.woff") format("woff"),
    url("<?php echo $baseURL; ?>/kalameh_old/bold/kalameh_bold.ttf") format("truetype");
}