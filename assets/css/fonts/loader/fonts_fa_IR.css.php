...
@font-face {
    ...
    font-weight: normal;
    font-display: swap;
    src: url("<?php echo $baseURL; ?>/kalameh/fa_normal/kalameh_fa_normal.woff2") format("woff2"),
         url("<?php echo $baseURL; ?>/kalameh/fa_normal/kalameh_fa_normal.woff") format("woff"),
         url("<?php echo $baseURL; ?>/kalameh/fa_normal/kalameh_fa_normal.ttf") format("truetype");
}
@font-face {
    font-family: 'kalameh';
    font-weight: bold;
    font-display: swap;
    src: url("<?php echo $baseURL; ?>/kalameh/fa_bold/kalameh_fa_bold.woff2") format("woff2"),
         url("<?php echo $baseURL; ?>/kalameh/fa_bold/kalameh_fa_bold.woff") format("woff"),
         url("<?php echo $baseURL; ?>/kalameh/fa_bold/kalameh_fa_bold.ttf") format("truetype");
}