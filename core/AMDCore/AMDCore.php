...
class AMDCore{
	...
	public function initAdmin(){
		...
		add_action( "admin_menu", function(){
			...
			add_menu_page( esc_html_x( "Material dashboard", "Admin", "material-dashboard" ), esc_html_x( "Dashboard", "Admin", "material-dashboard" ), "manage_options", "material-dashboard", [
				$this,
				"page_admin_dashboard"
			], AMD_IMG . "/logo/menu_icon.svg", 3 );

			add_submenu_page( "material-dashboard", esc_html_x( "Settings", "Admin", "material-dashboard" ), esc_html_x( "Settings", "Admin", "material-dashboard" ), "manage_options", "amd-settings", [
				$this,
				"submenu_admin_settings"
			] );

			add_submenu_page( "material-dashboard", esc_html_x( "Appearance", "Admin", "material-dashboard" ), esc_html_x( "Appearance", "Admin", "material-dashboard" ), "manage_options", "amd-appearance", [
				$this,
			...
			add_submenu_page( "material-dashboard", esc_html_x( "Security", "Admin", "material-dashboard" ), esc_html_x( "Security", "Admin", "material-dashboard" ), "manage_options", "amd-security", [
				$this,
				"submenu_admin_security"
			] );

			add_submenu_page( "material-dashboard", esc_html_x( "Wizard", "Admin", "material-dashboard" ), esc_html_x( "Wizard", "Admin", "material-dashboard" ), "manage_options", "amd-wizard", [
				$this,
				"admin_wizard_page"
			] );

			add_submenu_page( "material-dashboard", esc_html_x( "Extensions", "Admin", "material-dashboard" ), esc_html_x( "Extensions", "Admin", "material-dashboard" ), "manage_options", "amd-ext", [
				$this,
